...
const MyBookingScreen = () => {
  ...
  useEffect(() => {
    fetch("https://limitless-temple-11896.herokuapp.com/booking")
      .then((res) => res.json())
      .then((data) =>
  ...
  const handleDelete = (id) => {
    swal({
      ...
      if (willDelete) {
        axios
          .delete(`https://limitless-temple-11896.herokuapp.com/booking/${id}`)
          .then((res) => {
        ...
        swal("Booking Hasn't Deleted Yet. Your Booking Is Stay Here!!");
      }
    });
  };
